...
/*   Updated: 2024/06/28 14:36:32 by nsterk        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
class ScalarConverter {
	...
	private:
		...
		static void		printFloat(float f, int precision);
		static void		printDouble(double d, int precision);

		static int		getPrecision(std::string convertedValue);
		static void		isPseudo(std::string value);
};
